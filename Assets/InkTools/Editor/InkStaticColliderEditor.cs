...
[CustomEditor(typeof(InkStaticCollider))]
[CanEditMultipleObjects]
class InkStaticColliderEditor : Editor
{

    [MenuItem("GameObject/Create Other/Inkling/Ink Static Collider")]
    private static void Inkling_StaticCollider()
    {
        ...
        if (Resources.Load("InkStaticColliderObject") != null)
        {
            Instantiate( Resources.Load("InkStaticColliderObject")
                       , menuSpawnPosition
                       , Quaternion.identity
                       );
        }
        ...
        {
            Debug.LogError( "InkStaticColliderObject was not found in the Resources folder and could"
