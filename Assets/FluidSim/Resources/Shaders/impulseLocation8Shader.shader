...
Shader "FluidSim/impulseLocation8Shader"
{
	Properties
		{	
		...
		float4 frag(v2f i) : COLOR
			{
				...
				for(j = 0; j < 8; j++)
				{
					...
					tempCalc.a = impulseColor.a * clamp((distance(i.uv, float2(impulseLocationX, impulseLocationY)) - colorSize) * -colorFalloff, 0.0, 1.0);
