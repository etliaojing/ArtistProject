...
Shader "FluidSim/impulseLocationVelShader"
{
	Properties
		{	
			velTex ("velTex", 2D) = "" {}
...
v2f vert (appdata v)
{
	...
	return o;
		...
		float4 frag(v2f i) : COLOR
			{					//set to 15 instead of 16 because it breaks SM3.0 512 instruction limits.  Once we find an optimization to remove 1 arithmatic instruction, it should be updated to use the full 16 object cycle.
				for(j = 0; j < 15; j++)
				{
